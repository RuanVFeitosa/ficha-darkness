-- Correcao autocontida para bancos criados antes do suporte a varios mapas.
-- A coluna precisa existir antes da funcao de movimento ser criada.
...
grant execute on function public.mover_token_tabletop(uuid, numeric, numeric, text)
to anon, authenticated;
